...
int process_beq(const std::string &instruction, int line_num);
int process_bne(const std::string &instruction, int line_num);
int process_j(const std::string &instruction);
int process_jal(const std::string &instruction);
int process_jr(const std::string &instruction);
int process_jalr(const std::string &instruction);
int process_la(const std::string &instruction);
int process_and(const std::string &instruction);
int process_or(const std::string &instruction);
int process_not(const std::string &instruction);
int process_nor(const std::string &instruction);
int process_xor(const std::string &instruction);
int process_andi(const std::string &instruction);
int process_ori(const std::string &instruction);
int process_xori(const std::string &instruction);
int process_lui(const std::string &instruction);
int process_move(const std::string &instruction);
